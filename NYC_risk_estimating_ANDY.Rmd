...
# SET UP
# When running this project from a local computer there are two important steps that have to be taken:
# Unzip the CSV file, it should be placed in the "/data" directory within the main project and named "NYPD_Motor_Vehicle_Collisions.csv"  
# I don't know how to make the "C:/Users/Pedro Franco..." automoatic, so that you don't have to change this everytime we run it or change the user running it
# Below we are just organizing the data so that we have 

NYPD_table = "Data/NYPD_Motor_Vehicle_Collisions_Official_1.csv"
ProjectData <- read.csv("Data/NYPD_Motor_Vehicle_Collisions_Official_1.csv")
