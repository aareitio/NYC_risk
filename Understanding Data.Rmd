...
#1 --- *ANDY*: this is the example from class where  we need to download info from any source
...
#this files doesnt exist... it is just to remind us that there is another way to access data!
source("helpersSet1.R")
source("dataSet1.R")
```

#2 --- *ANDY*: this is the example from class where  we need to write a csv file
It wont work because the function StockReturns is not defined
...
#3 --- *ANDY*: this is the example from class where we can READ a csv file
